...
#define  LOG_TAG "VideoTool-ffmpeg"
void android_ffmpeg_callback( void* ptr, int level, const char* fmt, va_list vl )
{
    static int print_prefix = 1;
    static int count;
    static char prev[1024];
...
#ifdef __LGE__
static void (*av_log_callback)(void*, int, const char*, va_list) = android_ffmpeg_callback;
#else
