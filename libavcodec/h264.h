...
typedef enum {
   ...
   ,SEI_TYPE_STEREO_VIDEO_INFO          =  0x15
   ,SEI_TYPE_FRAME_PACKING_ARRANGEMENT  =  0x2D
#endif
} SEI_Type;
...
#if defined(__LGE__) && defined(__LGE_S3D__)
typedef enum {
    SEI_S3D_NORMAL                   =  0, ///< Normal Video (No 3D)
    SEI_S3D_TB                       =  1, ///< SEI 3D Video (Top & Bottom)
    SEI_S3D_LR                       =  2, ///< SEI 3D Video (Left & Right)
    SEI_S3D_RL                       =  3  ///< SEI 3D Video (Right & Left)
} SEI_S3dType;
#endif
